...
영역별로 비중을 얼마나 주어야할까 안드로이드개발? 자바나 코틀린에대한 지식? cs지식? 등  
공부하다보면 벨런스있게 전부 하기보다 한쪽에 치우쳐서 집중하는 경향이있음  
항상 염두해두고 다른부분 소홀히 하지 않기

프로젝트를 진행하다보면 느끼는게 프로젝트가 마무리되고나서는 뿌듯한 기분이 들지만 지금까지 진행한 프로젝트를 뜯어보면  
생각보다 놓치고 지나간 부분이 많다. 마치 내가 다 아는 것처럼..하는 착각.. 뭔가 속은 비어있는데 겉 껍질만 단단해지는 느낌??  
프로젝트를 많이 하는것도 중요하고, 여러가지 기술스텍들 익히는것도 물론 중요하지만, 속을 비워두고 껍질만 보강하는것 같아서 앞으로 진행할 프로젝트는 잠시 멈춰두고  
단단해진 겉껍칠만큼 속을 채워넣어야 겠다.
💡 다만, 나는 교수나 강사가 되려는게 아니다. 이론적으로 투머치하게 들어가면 오히려 별로일거 같다. 알아서 적당히  


### 남은거
+ 복습해야할 부분  
[2021-05-14] : 깡샘의 안드로이드 pdf  
[2021-05-15] : 깡샘의 안드로이드 pdf + 깜샘의 코틀린프로그래밍 pdf  
[2021-05-16] : 깜샘의 코틀린 프로그래밍 pdf  

아래 개인적으로 느끼는 중요도는 8️⃣ 🔟 ⏸ > why? Retrofit, RecyclerView, Glide 적극활용함  
그다음으로 7️⃣ 9️⃣ 5️⃣ 6️⃣  
...
🚩 5️⃣ 부터는 이전에 문법, 기능위주의 구현이 아니라 현업에서 많이 사용하는 라이브러리적인 측면? 을 다루고 있기 때문에  
  코틀린 기본적인 부분에대해서 확실히 하고 넘어가야함 위에 언급한대로 pdf 완벽은 아니더라도 전반적으로 다 체크하고 가는게 맞음  
  급하게 하지말자!!!


### 5월 17일 ~ 6월 11일 : 25일 동안 7강
+ 유튜브 클론 5월17일 ~ 
+ 멜론 클론 5월20일 ~
+ 위치검색 지도 5월24일 ~
+ OTT 5월27일 ~
...
+ 코딩테스트?? 대기업 준비용인데 사실 난 스타트업단위에서 두루두루 배우고 싶음.  
  근데 스타트업에서 원하는 인재상에 부합하려면 알아야할 스텍들이 말도 안대긴함.  
  그냥 안드로이드 앱개발만 하기보다 기획부터 마케팅 개발 디자인 영업 등 전부 배우고 싶음.  
  뭔가 배부른소리지만 대기업에서 코딩을 배우면 깊이는 깊어지지만 넓이는 그렇지 못할거같은 느낌쓰..  
  내가말하는 넓이란 코딩을 말하는게 아니라 위의 다른 영역들을 말하는 것임  
  솔직히 개인적으로도 개발을 남들보다 눈에띄게 잘한다? 라는 느낌이 없음.  
  그냥 뭔가 개발을 제일 잘하지만 기획이나 디자인 마케팅 등 다른 부분들도 어느정도 잘하는 느낌을 지향함.  
  나중엔 내가 오너가되야짘  
...
## 💬 아래에 내용정리를 잠깐 멈추는 이유..
뭔가 오히려 성장을 방해하는 느낌?? 적당히 아는게 중요한거같다.  
