...
우연히 유투브 코딩채널들을 둘러보다 보게된 영상이 있었는데  
지금까지 공부방식이 잘못되었다는 것을 깨닳았다.  
안드로이드 개발자로 방향을 잡고 공부한지도 6개월이 지나가는데  
지난날을 나는 개발자스럽게 보내지 못했다.  
무엇이 문제였을까?  

첫째, 안드로이드의 여러가지 기술스텍들을 익혀서 무엇이든 결과물을 만들어보는게 좋을거라는 잘못된 생각  
...
둘째, 그렇다면 위에말한 기술스텍을 경험해보기 위해 여러가지 결과물을 뽑아낸것은 시간 낭비었을까??  
  : 그건 아니라고 본다. 어쨌거나 점점 시야는 넓어지고 있으니까. 하지만 더욱 개발자 스럽기 위해선  
  나름대로의 노력이 더 들어가야한다. 내가 지금껏 만들어낸 결과물들에 대해서  
  버그를 찾아보고, 성능을 개선해보고, 구조를 개선하고, 필요한 다른 기능을 추가해 보는 등 지속적으로 발전 시켜야 한다.  
  워낙 빠르게 변하는 시장인지라 변화에 대응하는 능력이 필요하다고 본다.
  
세번째, 그렇다면 위에 말한 사항들에 입각해 개선된 방식으로 공부하면 괜찮은 걸까??  
  : 아니다. 개발자는 혼자일하지 않는다.  
