...
🟧🟧🟧🟧 구글서치문제 해결하기 firebase쓰는 3개 앱일단 먼저 복습할 때 Key값 다시 받아서 업로드하기(레포지토리 삭제한다고 깃기록이 지워지나?)
...
🚩 5️⃣ 부터는 이전에 문법, 기능위주의 구현이 아니라 현업에서 많이 사용하는 라이브러리적인 측면? 을 다루고 있기 때문에  
  코틀린 기본적인 부분에대해서 확실히 하고 넘어가야함 4️⃣까지해서 기본이되는 문법이나 기능구현들을 확실히 숙지하고,  
  코틀린 정독을 먼저 한후에 
...
+ 코딩테스트?? 대기업 준비용인데 사실 난 스타트업단위에서 두루두루 배우고 싶음.  
  ...
  그냥 뭔가 개발을 제일 잘하지만 기획이나 디자인 마케팅 등 다른 부분들도 어느정도 잘하는 다재다능형을 지향함.  
  나중엔 내가 오너가되야짘  
